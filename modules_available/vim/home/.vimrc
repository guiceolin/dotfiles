...
fun! SetupVAM()
  ...
  call vam#ActivateAddons( ['The_NERD_tree', 'fugitive','delimitMate', 'github:honza/snipmate-snippets', 'github:Lokaltog/vim-powerline', 'github:tpope/vim-bundler', 'github:kchmck/vim-coffee-script' ], {'auto_install' : 1})
